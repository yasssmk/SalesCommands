...
/**
 * Default export - object with all display functions
 * Allows for: import displayError from 'utils/displayError'
 * Then: displayError.error(err) or displayError.success(msg)
 */
export default {
  error: displayErrorSnackbar,
  success: displaySuccessSnackbar,
  warning: displayWarningSnackbar,
  info: displayInfoSnackbar
};