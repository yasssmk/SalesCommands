      ...
      children: [
        {
          ...
          type: 'item',
          url: isFeatureEnabled('ACCOUNT_MANAGEMENT') ? '/businessData/accounts' : '#',
        ...
        },
        {
          ...
          type: 'item',
          url: isFeatureEnabled('CONTACTS_MANAGEMENT') ? '/businessData/contacts' : '#',
        ...
        },
        {
          ...
          type: 'item',
          url: isFeatureEnabled('PRODUCTS_MANAGEMENT') ? '/businessData/products' : '#',
