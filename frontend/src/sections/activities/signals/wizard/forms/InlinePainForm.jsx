 ...
 * --------------------------------------------------------------
 * source_contact was retired from BaseSignal entirely. Combined with
 * the source_activity removal above, the form's "Source" section has
 * been retired entirely — the user no longer picks any provenance
 * data manually.
 *
