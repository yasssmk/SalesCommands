// frontend/src/sections/activities/signals/wizard/forms/InlineObjectiveForm.jsx
/**
 ...
 * + source_activity at dispatch time. Contact objects are kept whole;
...
export default function InlineObjectiveForm({
  ...
  /** Contact search scoped to this account only (target_contact picker). */
