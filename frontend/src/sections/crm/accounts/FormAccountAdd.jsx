...
// project imports
import AlertCustomerDelete from '../../apps/customer/AlertCustomerDelete';
...
export default function FormAccountAdd({ account, closeModal }) {
  ...
  const [avatar, setAvatar] = useState(
    `/assets/images/users/avatar-${account && account !== null && account?.avatar ? account.avatar : 1}.png`
  );
  ...
  return (
    <>
      ...
      {account && <AlertCustomerDelete id={account.id} title={account.name} open={openAlert} handleClose={handleAlertClose} />}
    </>
  );
}

FormAccountAdd.propTypes = { customer: PropTypes.any, closeModal: PropTypes.func };
