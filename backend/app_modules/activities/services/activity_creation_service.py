    ...
    def _create_activity(
        ...
        try:
            ...
            activity = Activity(
                ...
                description=activity_data.get('description', '').strip() or None,
                call_to_action=activity_data.get('call_to_action', '').strip() or None,
                ...
                outcome_notes=activity_data.get('outcome_notes', '').strip() or None,
